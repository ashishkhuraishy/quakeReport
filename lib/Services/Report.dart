...
Future<List<Report>> getReport(String startDate, String endDate, String mag) async {
  ...
  try {
    Response response = await get(
        'https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=$startDate&endtime=$endDate&minmagnitude=$mag&limit=1000');
    ...
    for (int i = 0; i < data["features"].length; i++) {
      ...
      _quakeReport.add(
          new Report(place: place,bgColor: _bgColor, near: near, mag: mag, time: formattedTime, url: url));
    }
    ...
    AlertDialog(title: Text("Network Error"),);
    return _quakeReport;
  }
}
